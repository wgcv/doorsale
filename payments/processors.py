...
class PayPal:
    ...
    def create_account_payment(self, order, user):
        ...
        try:
            ...
            raise Exception('We failed to process your PayPal account at the moment, please try again later!')
    ...
    def credit_card_payment(self, card, order, user):
        ...
        try:
            ...
            raise Exception('We failed to process your Credit Card at the moment, please try again later!')
